""" importFile(config::Config, record::Int, field::String, event::String, repeat_instance::Int, file;
...
function importFile(config::Config, record::Int, field::String, event::String, repeat_instance::Int, file;
					returnFormat::String="json")
